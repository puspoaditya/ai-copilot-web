  ...
  return (
    <main className="min-h-screen bg-dot-pattern text-white overflow-x-hidden">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-13 h-13 bg-[#25d366] hover:bg-[#1ebe5d] text-white rounded-full shadow-lg shadow-[#25d366]/30 transition"
